...
@InputType()
class OrigUserCreateNestedManyWithoutEventTypesInput {
...
export { OrigUserCreateNestedManyWithoutEventTypesInput as OrigUserCreateNestedManyWithoutEventTypesInput };
