...
import { OrigUserListRelationFilter } from "../../origUser/base/OrigUserListRelationFilter";
...
class EventTypeWhereInput {
  ...
  @ApiProperty({
    required: false,
    type: () => OrigUserListRelationFilter,
  })
  @ValidateNested()
  @Type(() => OrigUserListRelationFilter)
  @IsOptional()
  @Field(() => OrigUserListRelationFilter, {
    nullable: true,
  })
  users?: OrigUserListRelationFilter;
