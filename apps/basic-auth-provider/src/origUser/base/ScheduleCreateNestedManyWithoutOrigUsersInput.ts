...
@InputType()
class ScheduleCreateNestedManyWithoutOrigUsersInput {
...
export { ScheduleCreateNestedManyWithoutOrigUsersInput as ScheduleCreateNestedManyWithoutOrigUsersInput };
