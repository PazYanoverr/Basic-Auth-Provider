...
@InputType()
class FeedbackCreateNestedManyWithoutOrigUsersInput {
...
export { FeedbackCreateNestedManyWithoutOrigUsersInput as FeedbackCreateNestedManyWithoutOrigUsersInput };
