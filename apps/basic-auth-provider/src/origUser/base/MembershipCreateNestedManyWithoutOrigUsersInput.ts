...
@InputType()
class MembershipCreateNestedManyWithoutOrigUsersInput {
...
export { MembershipCreateNestedManyWithoutOrigUsersInput as MembershipCreateNestedManyWithoutOrigUsersInput };
