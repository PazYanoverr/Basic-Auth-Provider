...
@InputType()
class SelectedCalendarCreateNestedManyWithoutOrigUsersInput {
...
export { SelectedCalendarCreateNestedManyWithoutOrigUsersInput as SelectedCalendarCreateNestedManyWithoutOrigUsersInput };
