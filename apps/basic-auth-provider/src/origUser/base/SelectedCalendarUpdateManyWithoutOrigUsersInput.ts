...
@InputType()
class SelectedCalendarUpdateManyWithoutOrigUsersInput {
...
export { SelectedCalendarUpdateManyWithoutOrigUsersInput as SelectedCalendarUpdateManyWithoutOrigUsersInput };
