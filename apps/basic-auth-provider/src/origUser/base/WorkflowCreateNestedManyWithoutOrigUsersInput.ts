...
@InputType()
class WorkflowCreateNestedManyWithoutOrigUsersInput {
...
export { WorkflowCreateNestedManyWithoutOrigUsersInput as WorkflowCreateNestedManyWithoutOrigUsersInput };
