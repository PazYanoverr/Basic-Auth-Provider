...
@InputType()
class CredentialCreateNestedManyWithoutOrigUsersInput {
...
export { CredentialCreateNestedManyWithoutOrigUsersInput as CredentialCreateNestedManyWithoutOrigUsersInput };
